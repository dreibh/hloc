...
if [ -z $1 ] || [ -z $2 ] || [ -z $3 ] || [ ! -d $4 ]; then
    ...
    python3 -m hloc.scripts.codes_parser --database-name $1 -ao hloc/data/pages_offline -le "data/location-data/locodePart{}.csv" -c data/location-data/clli-lat-lon.txt -g data/location-data/cities1000.txt -e data/location-data/iata_metropolitan.txt -m 100 -p 100000 -l ${logPath}/codes-parsing -ll DEBUG -d
